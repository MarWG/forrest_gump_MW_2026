# Proyecto Forrest Gump - ~~Segundo Parcial Programación Web 1~~ FINAL! -cuatrimestre 1-2026

Este proyecto es la mejora visual y de compatibilidad del sitio realizado para el segundo parcial. 
Incluyendo mejoras en las páginas fuera del HOME, mejorando la actitud responsive del sitio, e incorporando un par de tácticas para que esto funcione bien
...
Todas las páginas muestran ahora actitud responsive, cambios respecto a 3 tamaños, MOVIL; TABLET; PC (375px, 676px, 1024px) 
